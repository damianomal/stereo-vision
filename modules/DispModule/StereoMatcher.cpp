...
//    std::cout << "AAAA " << this->speckleRange << std::endl;
}
...
//                this->disparity_wls.convertTo(this->disparity16_wls, CV_16SC1, 16.0);
